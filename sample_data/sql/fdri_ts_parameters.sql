CREATE TABLE IF NOT EXISTS TS AS FROM read_csv('./sample_data/src/TIMESERIES_IDS_FDRI.csv', AUTO_DETECT=true);
...
) TO './build/fdri_ts_parameters.csv' (HEADER, DELIMITER ',') ;