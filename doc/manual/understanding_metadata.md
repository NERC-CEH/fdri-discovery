...
- **site**: site from the given network. See `SITES_COSMOS.csv` for a list of 51 COSMOS sites, and similarly `SITES_NMDB.csv`, `SITES_NRFA.csv`, `SITES_FDRI.csv`, `AMS_sites.csv`, etc. The naming conventions for these files will be made consistent in due course.
